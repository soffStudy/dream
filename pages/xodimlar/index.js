                                        ...
                                        .map((row, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="right" className="text-center" >{row.lavozimi}</TableCell>
                                                    <TableCell align="right" className="text-center">{row.boshlaganVaqti}</TableCell>
